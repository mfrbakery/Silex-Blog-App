...
class UserAdminController implements ControllerProviderInterface {
  ...
  function connect(Application $app) {
    ...
    $userAdmin->get("/profile", "MyApp\Controller\Admin\UserAdminController::profile")->bind("admin.user.profile");
    $userAdmin->get("/logout", "MyApp\Controller\Admin\UserAdminController::logout")->bind('admin.user.logout');
    return $userAdmin;
  }
